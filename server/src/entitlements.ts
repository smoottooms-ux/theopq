...
export const PLANS: Record<PlanId, Plan> = {
  ...
  family: {
    ...
    price: 1299,
    period: 'month',
    // Sized from the provider bill, not from a round number: see docs/PRICING.md.
    // Replays are free, so this only has to cover genuinely new narration.
    narrationChars: 120_000,
    storiesPerPeriod: 30,
    voiceSlots: 2,
    blurb: 'Two grown-ups, unlimited kids, and the whole library in your voice.',
  },
  family_annual: {
    id: 'family_annual',
    label: 'Family, yearly',
    ...
    storiesPerPeriod: 30,
    voiceSlots: 2,
    blurb: 'The same thing, five months cheaper.',
  },
  lifetime: {
    id: 'lifetime',
    label: 'Lifetime',
    ...
    storiesPerPeriod: 30,
    voiceSlots: 3,
    blurb: 'Pay once. Monthly allowances still reset.',
  },
  comp: {
    id: 'comp',
    label: 'Complimentary',
